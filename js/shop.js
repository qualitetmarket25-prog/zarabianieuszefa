// js/sklep.js
// Sklep + koszyk (UI) + multi-store sync + produkty z LS/JSON + ceny z pricing.js
...
(() => {
  ...
  const normalizeProduct = (p) => {
    ...
    const image = pickFirstString(p.image, p.img, p.photo, p.zdjecie) || hashPick(name);
